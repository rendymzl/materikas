...
// void purchaseOrderDialog({bool isMobile = false}) async {
...
//     height: MediaQuery.of(Get.context!).size.height * (isMobile ? 0.65 : 6 / 7),
//     width: MediaQuery.of(Get.context!).size.width * (isMobile ? 0.9 : 0.50),
//     content: Obx(
//       () => Expanded(
