        ...
        children: [
          ...
          Expanded(
            ...
            child: SelectedProductSales(
              po: true,
              purchaseOrder: editedPurchaseOrder,
            ),
          ),
        ],
      ),
            ...
            Get.defaultDialog(
              ...
              confirm: TextButton(
                onPressed: () async {
                  ...
                  if (purchaseOrder != null) {
                    editedPurchaseOrder!.orderId = controller.invoice.invoiceId;
                    ...
                    final purchaseOrder = PurchaseOrderModel(
                      ...
                      orderId: controller.invoice.invoiceId,
                      createdAt: controller.invoice.createdAt.value,
