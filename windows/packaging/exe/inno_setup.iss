...
Source: "{{SOURCE_DIR}}\PrintImage.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{{SOURCE_DIR}}\template_tambah_barang_materikas.xlsx"; DestDir: "{app}"; Flags: ignoreversion
